...
emmip(lmm, ~ manipulation|group*trial, linearg = list(linetype = "blank"), CI = T)
```
...
### Post-hoc: manipulation x group x block x oddball_trial_counter
```{r, warning=FALSE}
